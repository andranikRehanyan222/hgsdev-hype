<?php $__env->startSection('template_title'); ?>
    <?php echo __('Your PayPal settings'); ?>
...
<form action="<?php echo e(route('setting.paypal_post')); ?>" class=" mb-4 widget-content widget-content-area" method="POST">
...
<select class="custom-select custom-select-sm mb-4" name="paypal_mode" id="paypal_mode">
  <option value="sandbox"
   <?php if('sandbox' == $data['paypal_mode']): ?>
   selected="selected"
   <?php endif; ?>
   >Sandbox</option>
  <option value="live"
   <?php if('live' == $data['paypal_mode']): ?>
   selected="selected"
   <?php endif; ?>
   >LIVE</option>
</select>
...
<div class="form-group row mb-4">
    ...
    <div class="col-xl-10 col-lg-9 col-sm-10">
        <input value="<?php echo e($data['paypal_sandbox_secret']); ?>" type="text" name="paypal_sandbox_secret" class="form-control" id="paypal_sandbox_secret" placeholder="">
    </div>
</div>
...
<div class="form-group row mb-4">
    ...
    <div class="col-xl-10 col-lg-9 col-sm-10">
        <input value="<?php echo e($data['paypal_sandbox_certificate']); ?>" type="text" name="paypal_sandbox_certificate" class="form-control" id="paypal_sandbox_certificate" placeholder="">
    </div>
</div>
...
<div class="form-group row mb-4">
    ...
    <div class="col-xl-10 col-lg-9 col-sm-10">
        <input value="<?php echo e($data['paypal_live_secret']); ?>" type="text" name="paypal_live_secret" class="form-control" id="paypal_live_secret" placeholder="">
    </div>
</div>
...
<div class="form-group row mb-4">
    ...
    <div class="col-xl-10 col-lg-9 col-sm-10">
        <input value="<?php echo e($data['paypal_live_certificate']); ?>" type="text" name="paypal_live_certificate" class="form-control" id="paypal_live_certificate" placeholder="">
    </div>
</div>
