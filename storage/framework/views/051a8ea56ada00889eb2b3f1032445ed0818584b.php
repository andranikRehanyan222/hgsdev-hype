        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="navbar-nav theme-brand flex-row  d-none d-lg-flex">
                    <li class="nav-item d-flex">
                        <a href="index.html" class="">
                            <img src="<?php echo e(asset('img/hypelogo.png')); ?>" class="img-fluid" alt="logo">
                        </a>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        <a href="/powerlikes" class="dropdown-toggle">
                            <div class="">
                                <i class="flaticon-cart-2"></i>
                                <span>Powerlikes</span>
                            </div>
                            <div>
                    ...
                    <li class="menu">
                        <a href="/fuelgroups" class="dropdown-toggle">
                            <div class="">
                                <i class="flaticon-edit-3"></i>
                                <span>Hypegroups</span>
                            </div>
                            <div>
                                <i class="flaticon-right-arrow"></i>
                            </div>
                    ...
                    <li class="menu">
                        <a href="/autorounds" class="dropdown-toggle">
                            <div class="">
                                <i class="flaticon-table"></i>
                                <span>Roundgroups</span>
                            </div>
                            <div>
                                <i class="flaticon-right-arrow"></i>
                            </div>
                    ...
                    <li class="menu">
                        <a href="/accounts" class="dropdown-toggle">
                            <div class="">
                    ...
                    <?php if(Auth::user()->role == 'admin'): ?>
                    <li class="menu">
                        <a href="<?php echo e(route('product')); ?>" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="<?php echo e(route('order')); ?>" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="<?php echo e(route('support')); ?>" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="<?php echo e(route('setting')); ?>" class="dropdown-toggle">
                            <div class="">
                                <i class="flaticon-setting-line"></i>
                                <span>Setting</span>
                            </div>
...
<div class="page-header">
                    <div class="page-title w-100">
                        <h3>
                            <?php if(trim($__env->yieldContent('template_h1'))): ?><?php echo $__env->yieldContent('template_h1'); ?> 
                            <?php elseif(trim($__env->yieldContent('template_title'))): ?><?php echo $__env->yieldContent('template_title'); ?> 
                            <?php endif; ?> 
                        </h3>
...
<?php echo $__env->yieldContent('content'); ?>
    ...
    <!-- END GLOBAL MANDATORY SCRIPTS -->
        ...
        <?php endif; ?>
        <?php echo $__env->make('laravelusers::scripts.toggleText', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
