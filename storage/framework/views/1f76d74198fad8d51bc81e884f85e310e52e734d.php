...
<a href="<?php echo e(route('fuelgroups.reload')); ?>" class="btn btn-gradient-primary btn-rounded d-inline"><i class="flaticon-circle-reload-line"></i> Reload from Fuelgram</a>
<?php endif; ?>
...
<?php if(Auth::user()->role == 'admin'): ?>
<a href="<?php echo e(route('fuelgroups.edit', ['id' => $value->id])); ?>" class="btn btn-gradient-primary btn-rounded float-right"><i class="flaticon-edit-6"></i> Edit</a>
<?php endif; ?>

                    <h3>
                        <a href="<?php echo e(route('fuelgroups.show', ['id' => $value->id])); ?>">
