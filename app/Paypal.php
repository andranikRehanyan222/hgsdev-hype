...
class Paypal {
	...
	*/
	public function __construct() {
		...
		$this->public_key = $data['paypal_mode'];
		$this->_apiUrl = config('paypal.endpoints')[$this->public_key];

		$this->paypal_secret = $data['paypal_' . $this->public_key . '_secret'];
		$this->paypal_certificate = $data['paypal_' . $this->public_key . '_certificate'];
		$this->sec_cert =  $this->paypal_secret . ":" . $this->paypal_certificate;
	...
	*/
	private function _getToken() {
		...
		$this->_http->setAuthentication($this->sec_cert);
