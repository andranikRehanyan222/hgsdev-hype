            ...
            <li class="nav-item dropdown app-dropdown  ml-lg-4 mr-lg-2 order-lg-0 order-2">
                ...
                <div class="dropdown-menu  position-absolute" aria-labelledby="appDropdown">
                    <a class="dropdown-item" href="ecommerce_dashboard.html">
                        <i class="flaticon-commerce"></i><span>Powerlikes</span>
                    </a>
                    <a class="dropdown-item" href="form_bootstrap_basic.html">
                        <i class="flaticon-edit-3"></i><span>Hypegroups</span>
                    </a>
                    <a class="dropdown-item" href="table_basic.html">
                        <i class="flaticon-table"></i><span>Roundgroups</span>
                    </a>
                </div>
            </li> --}}
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="navbar-nav theme-brand flex-row  d-none d-lg-flex">
                    <li class="nav-item d-flex">
                        <a href="index.html" class="{{-- navbar-brand --}}">
                            <img src="{{asset('img/hypelogo.png')}}" class="img-fluid" alt="logo">
                        </a>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    @if(Auth::user()->role == 'admin')
                    <li class="menu">
                        <a href="{{ route('product') }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{ route('order') }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{ route('support') }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{ route('setting') }}" class="dropdown-toggle">
                            <div class="">
                                <i class="flaticon-setting-line"></i>
                                <span>Setting</span>
                            </div>
...
<div class="page-header">
                    <div class="page-title w-100">
                        <h3>
                            @if (trim($__env->yieldContent('template_h1')))@yield('template_h1') 
                            @elseif (trim($__env->yieldContent('template_title')))@yield('template_title') 
                            @endif 
                        </h3>
