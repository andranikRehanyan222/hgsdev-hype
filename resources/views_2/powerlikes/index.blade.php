...
trial_duration: {{$value->trial_duration}} <br/>
                    ...
                    @if(isset($value->addons->extra_post))<br/>
Addons:<br/>
name: {{$value->addons->extra_post->name}}<br/>
required: <?=$value->addons->extra_post->required? 'true' : 'false'?><br/>
cost: {{$value->addons->extra_post->cost}}<br/>
min_quantity: {{$value->addons->extra_post->min_quantity}}<br/>
max_quantity: {{$value->addons->extra_post->max_quantity}}<br/>
plan: {{$value->addons->extra_post->plan}}<br/>

<!--
<?var_dump($value->addons->extra_post)?>
-->
                    @endif
